select-employer = <b>Scrivi il nome dell'employer per cui vuoi applicare</b>

    <i>Per vedere la lista dei datori di lavoro disponibili, usa il comando <code>{ get-employers-cmd }</code>.</i>

received-employer = <b>Grazie per aver impostato l'employer!</b> { send-media }
...
unrecognized-message = Questo messaggio non è valido. Per favore invia un messaggio testuale, un audio o un'immagine.

sent-media = Stiamo mandando i tuoi contenuti all'AI. Il riassunto arriverà a breve.
